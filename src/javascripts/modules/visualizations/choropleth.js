...
class Choropleth {
  ...
  loadData() {
    d3.queue()
      ...
      .defer(d3.csv, this.dataUrl, (d) => this.rateById.set(d.Counties, [d[`Percent change in household income by county from 2007-2015`], d[`Household Median income (dollars) 2007`], d[`Household Median income (dollars) 2015`]]))
